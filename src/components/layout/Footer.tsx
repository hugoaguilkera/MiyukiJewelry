      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="mb-4 text-gray-300">Creando joyas artesanales con pasión y dedicación. Cada pieza es única y hecha con amor.</p>
            <div className="flex space-x-4">
              ...
              <a href="https://whatsapp.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#D4AF37] transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-300">Av. Principal 123, CDMX</span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@miyuki.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">&copy; 2023 Miyuki. Todos los derechos reservados.</p>
            <div className="flex space-x-6">
              <a href="#" className="text-gray-400 hover:text-[#D4AF37] text-sm transition-colors">Política de Privacidad</a>
              <a href="#" className="text-gray-400 hover:text-[#D4AF37] text-sm transition-colors">Términos y Condiciones</a>
            </div>
          </div>
        </div>
      </div>
